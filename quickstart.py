...
r = requests.get('https://nemo-public.s3.us-east-2.amazonaws.com/zh-samples/common_voice_zh-CN_21347786.mp3')
with open('voice.mp3', 'wb') as f:
    f.write(r.content)


# Instantiate a Mandarin speech recognition model and transcribe an audio file.
asr_model = asr.models.ASRModel.from_pretrained(model_name="stt_zh_citrinet_1024_gamma_0_25")
mandarin_text = asr_model.transcribe(['voice.mp3'])
print(mandarin_text)

# Instantiate Neural Machine Translation model and translate the text
nmt_model = nlp.models.MTEncDecModel.from_pretrained(model_name="nmt_zh_en_transformer24x6")
